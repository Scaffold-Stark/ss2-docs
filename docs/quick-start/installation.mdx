...
will install the version `2.9.2` of Scarb.
...
We strongly recommend that you install Starknet Foundry via [asdf](https://docs.swmansion.com/scarb/download.html#install-via-asdf).
...
```bash
asdf global starknet-foundry 0.35.1
```
