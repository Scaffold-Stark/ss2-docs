...
```bash
curl --proto '=https' --tlsv1.2 -sSf https://docs.swmansion.com/scarb/install.sh | sh -s -- -v 2.7.1
```
...
To ensure the proper functioning of scaffold-stark, your local starknet-devnet version must be 0.2.0.
