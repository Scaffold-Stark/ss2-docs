...
Default Alchemy API key from Scaffold-Stark 2 for local testing purposes.
...
WalletConnect's default project ID from Scaffold-Stark 2 for local testing purposes.
