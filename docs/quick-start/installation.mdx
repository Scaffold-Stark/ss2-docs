...
To ensure the proper functioning of scaffold-stark, your `Scarb` version must be `2.11.3`. To accomplish this, first check your `Scarb` version:

```sh
scarb --version
```

If your Scarb version is not `2.11.3`, you need to install it.
...
Otherwise, you can install Scarb `2.11.3` following the [installation instructions](https://docs.swmansion.com/scarb/download).
...
This will allow you to download specific versions. You can choose the same version as the Cairo's version, for example, 2.11.3, with the following command:
...
```bash
asdf set scarb 2.11.3
```

Otherwise, you can simply run the following command in your terminal, and follow the onscreen instructions. This
will install the version `2.11.3` of Scarb.

```bash
curl --proto '=https' --tlsv1.2 -sSf https://docs.swmansion.com/scarb/install.sh | sh -s -- -v 2.11.3
```
...
To ensure the proper functioning of scaffold-stark, your starknet-devnet version must be 0.3.0
...
This will allow you to download specific versions. You can install the compatible version **0.3.0** with:
...
```bash
asdf set starknet-devnet 0.3.0
```

Otherwise, you can simply run the following command in your terminal and follow the on-screen instructions.  
This will install the version **0.3.0** of Starknet Devnet:

```bash
curl -L https://raw.githubusercontent.com/Shard-Labs/starknet-devnet/main/install.sh | bash -s -- -v 0.3.0
```
